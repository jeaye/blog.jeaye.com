...
This makes having multiple versions of a package trivial, since they're stored
in different directories. Only when a package requires a certain version of
another will they be linked together.
