---
title: vimb: the vim-like web browser
...
Recently, I stumbled across [vimb](http://fanglingsu.github.io/vimb/) which is a webkit based browser designed from the bottom up to work like vim. A possible benefit of this is that vimb is its own browser, not just a firefox plugin; this means there's none of the firefox bloat around. That may be a drawback for some who rely on other firefox plugins.
