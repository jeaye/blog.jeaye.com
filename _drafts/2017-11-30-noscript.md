...
over each of them to see a tooltip for what they do, and it's analogous to the
previous NoScript's behavior.

TODO: image of buttons

### Room for improvement
NoScript 10 has come a long way in the past month, but this UI could certainly
...
also think that more text in the UI would allow new users to pick it up more
quickly. Lastly, **Untrusted** should be **Distrusted**, but now we're just
splitting hairs.
